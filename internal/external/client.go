...
func (c *SpaceXAPIClient) CheckScheduledLaunches(body models.RequestBody) (models.LaunchesResponse, error) {
	url := c.BaseURL + "launches/query"

	var result models.LaunchesResponse
...
func (c *SpaceXAPIClient) CheckLaunchpadState(id string) (string, error) {
	...
	// So this endpoint requests a single launchpad and returns Status.
